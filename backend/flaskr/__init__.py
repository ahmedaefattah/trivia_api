...
def create_app(test_config=None):
  ...
  def search_questions():
    ...
    try:
      search_query  =   Question.question.ilike('%' + search_term + '%')
      search_response = Question.query.order_by(Question.id).filter(search_query).all()
      current_questions = paginate_questions(request, search_response)
  ...
  # Handle error 422 "Unprocessable"
